            ...
            <Grid spacing={2} justifyContent="flex-end" container>
              ...
              <Grid xs={12} sm={6} md={2} item>
                <FormControl margin="dense" variant="outlined" fullWidth>
                  <InputLabel htmlFor="plan-selection">{i18n.t("companies.plan")}</InputLabel>
                  <Field
                    as={Select}
                    id="plan-selection"
                    label={i18n.t("companies.plan")}
              ...
              <Grid xs={12} sm={6} md={2} item>
                <FormControl margin="dense" variant="outlined" fullWidth>
                  <InputLabel htmlFor="recorrencia-selection">
                    {i18n.t("common.recurrence")}
                  </InputLabel>
                  <Field
                    as={Select}
                    label={i18n.t("common.recurrence")}
                    labelId="recorrencia-selection-label"
                    id="recurrence"
                    name="recurrence"
                    margin="dense"
                  >
                    <MenuItem value="MENSAL">{i18n.t("common.recurrence.monthly") || "Mensal"}</MenuItem>
                    <MenuItem value="BIMESTRAL">{i18n.t("common.recurrence.bimonthly") || "Bimestral"}</MenuItem>
                    <MenuItem value="TRIMESTRAL">{i18n.t("common.recurrence.quarterly") || "Trimestral"}</MenuItem>
                    <MenuItem value="SEMESTRAL">{i18n.t("common.recurrence.semiannual") || "Semestral"}</MenuItem>
                    <MenuItem value="ANUAL">{i18n.t("common.recurrence.annual") || "Anual"}</MenuItem>
                  </Field>
                </FormControl>
              </Grid>
              <Grid xs={12} item>
...
export function CompaniesManagerGrid(props) {
  ...
  const renderCampaignsStatus = (row) => {
    if (
      ...
      if (setting) {
        return setting.value === "true" ? i18n.t("common.enabled") : i18n.t("common.disabled");
      }
    }
      ...
      >
        <TableHead>
          <TableRow>
            ...
            <TableCell align="left">{i18n.t("companies.plan")}</TableCell>
            <TableCell align="left">{i18n.t("companies.campaigns")}</TableCell>
            <TableCell align="left">{i18n.t("common.status")}</TableCell>
            <TableCell align="left">{i18n.t("companies.created")}</TableCell>
            <TableCell align="left">{i18n.t("companies.dueDate")}</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {records.map((row, key) => (
